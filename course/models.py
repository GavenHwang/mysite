...
class Lesson(models.Model):
    user = models.ForeignKey(User, related_name="lesson_user", on_delete=models.PROTECT)
    course = models.ForeignKey(Course, related_name="lesson", on_delete=models.PROTECT)
    title = models.CharField(max_length=200)
