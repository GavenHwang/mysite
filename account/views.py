...
def user_login(request):
    ...
    if request.method == "POST":
        ...
        if login_form.is_valid():
            ...
            if user:
                login(request, user)
                return HttpResponse("Welcome You. You have been authenticated successfuly")
            else:
...
def register(request):
    if request.method == 'POST':
        ...
        if user_form.is_valid()*userprofile_form.is_valid():
            ...
            return HttpResponseRedirect(reverse("account:user_login"), {'username': new_user.username})
        else:
